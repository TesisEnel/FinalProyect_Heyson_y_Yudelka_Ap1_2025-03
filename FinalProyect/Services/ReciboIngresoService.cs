...
namespace FinalProyect.Services
{
    public class ReciboIngresoService
    {
        ...
        {
            if (_context.ReciboIngreso == null) return new List<ReciboIngreso>();
        ...
        {
            if (_context.ReciboIngreso == null) throw new InvalidOperationException("Entity set is null.");
        ...
        {
            if (_context.ReciboIngreso == null) return false;
        ...
        public async Task<bool> ConfirmarRecibo(int reciboId, int documentoId)
        {
            ...
            if (recibo.Documentos == null) recibo.Documentos = new List<Documento>();
